...
g1_v(22)=(-1);
g1_v(23)=1-params(9);
g1_v(24)=params(5)*getPowerDeriv(y(10),params(6),1);
g1_v(25)=(-(y(1)*T(2)*getPowerDeriv(y(10),1-params(4),1)));
g1_v(26)=(-((-(y(2)*(1-params(4))))/(y(10)*y(10))));
g1_v(27)=(-T(1));
g1_v(28)=1;
g1_v(29)=(-params(2));
g1_v(30)=1;
g1_v(31)=(-(1-(1-params(3))));
g1_v(32)=(-(T(3)*y(1)*getPowerDeriv(y(13),params(4),1)));
g1_v(33)=(-(params(4)*(-y(2))/(y(13)*y(13))));
