...
residual=NaN(8, 1);
  ...
  T(4)=params(2)*y(30)^(-params(1));
  residual(5)=(T(3)*(1+params(8)*(y(24)-y(12))))-(T(4)*(1-params(3)+y(33)-params(8)*(y(36)-y(24))));
  residual(6)=((y(30)/y(18))^params(1))-(params(2)*(1+y(27)));
  ...
  T(7)=getPowerDeriv(y(30)/y(18),params(1),1);
if nargout > 3
    g1_v = NaN(29, 1);
g1_v(1)=(-(1+y(15)));
...
g1_v(17)=params(8)*T(3)-params(8)*T(4);
g1_v(18)=(-(y(20)*T(6)));
g1_v(19)=1;
g1_v(20)=(1+params(8)*(y(24)-y(12)))*T(6);
g1_v(21)=(-y(30))/(y(18)*y(18))*T(7);
g1_v(22)=(-y(2));
g1_v(23)=1;
g1_v(24)=1;
g1_v(25)=(-(T(4)*(-params(8))));
g1_v(26)=(-((1-params(3)+y(33)-params(8)*(y(36)-y(24)))*params(2)*getPowerDeriv(y(30),(-params(1)),1)));
g1_v(27)=T(7)*1/y(18);
g1_v(28)=(-params(2));
g1_v(29)=(-T(4));
