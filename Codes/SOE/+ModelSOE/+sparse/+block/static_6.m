...
residual=NaN(6, 1);
  ...
  residual(4)=(y(7)+y(5)+y(4))-(y(2)+(1+y(8))*y(7)+y(9));
  T(4)=y(4)^(-params(1));
...
if nargout > 3
    g1_v = NaN(16, 1);
g1_v(1)=1;
g1_v(2)=(-(params(4)*1/y(13)));
g1_v(3)=(-((1-params(4))/y(10)));
g1_v(4)=(-1);
g1_v(5)=(-(T(3)*y(1)*getPowerDeriv(y(13),params(4),1)));
g1_v(6)=(-(params(4)*(-y(2))/(y(13)*y(13))));
g1_v(7)=(-(1-(1-params(3))));
g1_v(8)=1;
g1_v(9)=(-T(4));
g1_v(10)=1;
g1_v(11)=(-(y(11)*getPowerDeriv(y(4),(-params(1)),1)));
g1_v(12)=(-(T(2)*getPowerDeriv(y(10),1-params(4),1)));
g1_v(13)=(-((-(y(2)*(1-params(4))))/(y(10)*y(10))));
g1_v(14)=params(5)*getPowerDeriv(y(10),params(6),1);
g1_v(15)=1;
g1_v(16)=1;
