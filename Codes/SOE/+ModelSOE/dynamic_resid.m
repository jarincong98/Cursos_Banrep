...
residual = zeros(13, 1);
    residual(1) = (y(9)) - (y(17)-(1-params(3))*y(4)+params(8)/2*(y(17)-y(4))^2);
    residual(2) = (params(5)*y(14)^params(6)) - (T(1)*y(15));
    residual(3) = (T(2)*(1+params(8)*(y(17)-y(4)))) - (params(2)*(1-params(3)+y(20)-params(8)*(y(21)-y(17))));
    residual(4) = (T(2)) - (params(2)*(1+y(19)));
    residual(5) = (y(12)) - (params(14)*exp(params(10)*(y(11)-params(12))));
    residual(6) = (y(6)) - (y(5)*T(3)*T(4));
    residual(7) = (y(16)) - (params(4)*y(6)/y(4));
    residual(8) = (y(15)) - (y(6)*(1-params(4))/y(14));
    residual(9) = (y(11)+y(9)+y(8)) - (y(6)+(1+y(12))*y(2)+y(13));
    residual(10) = (y(5)) - (y(1)*params(7)+params(11)*(1-params(7))+x(it_, 1));
    residual(11) = (y(13)) - (y(3)*params(9)+params(13)*(1-params(9))+x(it_, 2));
    residual(12) = (y(10)) - (y(6)-y(8)-y(9));
