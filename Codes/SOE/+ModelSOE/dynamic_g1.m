...
g1(2,15)=(-T(2));
g1(3,8)=(1+params(8)*(y(17)-y(4)))*(-y(18))/(y(8)*y(8))*T(6);
g1(3,18)=(1+params(8)*(y(17)-y(4)))*T(6)*1/y(8);
g1(3,20)=(-params(2));
g1(3,4)=T(3)*(-params(8));
g1(3,17)=params(8)*T(3)-params(8)*params(2);
g1(3,21)=(-(params(2)*(-params(8))));
g1(4,8)=(-y(18))/(y(8)*y(8))*T(6);
g1(4,18)=T(6)*1/y(8);
g1(4,19)=(-params(2));
...
g1(6,5)=(-(T(4)*T(5)));
g1(6,6)=1;
g1(6,14)=(-(y(5)*T(4)*getPowerDeriv(y(14),1-params(4),1)));
g1(6,4)=(-(T(5)*y(5)*getPowerDeriv(y(4),params(4),1)));
...
g1(12,9)=1;
g1(12,10)=1;
g1(12,4)=(-(params(8)/2*(-(2*(y(17)-y(4))))));
g1(12,17)=(-(params(8)/2*2*(y(17)-y(4))));
