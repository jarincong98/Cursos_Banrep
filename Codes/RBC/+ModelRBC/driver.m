...
M_.endo_names_long(3) = {'Trabajo'};
M_.endo_names(4) = {'K'};
M_.endo_names_tex(4) = {'K'};
M_.endo_names_long(4) = {'Capital'};
M_.endo_names(5) = {'Y'};
M_.endo_names_tex(5) = {'Y'};
M_.endo_names_long(5) = {'Produción'};
M_.endo_names(6) = {'I'};
M_.endo_names_tex(6) = {'I'};
M_.endo_names_long(6) = {'Inversión'};
M_.endo_names(7) = {'C'};
M_.endo_names_tex(7) = {'C'};
M_.endo_names_long(7) = {'Consumo'};
M_.endo_names(8) = {'A'};
M_.endo_names_tex(8) = {'A'};
M_.endo_names_long(8) = {'Productividad'};
...
M_.block_structure.block(2).variable = [ 2 6 5 1 3 4 7];
...
M_.block_structure.block(2).g1_sparse_rowval = int32([1 2 5 6 1 6 2 7 1 3 5 7 3 4 3 4 5 2 6 4 6 7 6 ]);
M_.block_structure.block(2).g1_sparse_colval = int32([6 6 6 6 8 8 9 9 10 10 10 10 11 11 12 12 12 13 13 14 14 14 21 ]);
M_.block_structure.block(2).g1_sparse_colptr = int32([1 1 1 1 1 1 5 5 7 9 13 15 18 20 23 23 23 23 23 23 23 24 ]);
M_.block_structure.variable_reordered = [ 8 2 6 5 1 3 4 7];
M_.block_structure.equation_reordered = [ 7 2 3 4 5 1 6 8];
...
M_.dynamic_g1_sparse_rowval = int32([1 2 3 6 7 4 5 2 6 1 4 5 3 6 1 2 4 8 3 8 5 6 8 1 7 6 7 ]);
M_.dynamic_g1_sparse_colval = int32([4 4 4 4 8 9 9 10 10 11 11 11 12 12 13 13 13 13 14 14 15 15 15 16 16 23 25 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 1 5 5 5 5 6 8 10 13 15 19 21 24 26 26 26 26 26 26 26 27 27 28 ]);
M_.lhs = {
'Y'; 
'R_K'; 
'K'; 
...
M_.block_structure_stat.block(1).variable = [ 2];
...
M_.block_structure_stat.block(3).variable = [ 6 3 1 5 4 7];
M_.block_structure_stat.variable_reordered = [ 2 8 6 3 1 5 4 7];
...
M_.static_g1_sparse_rowval = int32([4 5 2 6 1 4 5 1 2 3 1 2 4 8 3 8 5 8 1 7 ]);
M_.static_g1_sparse_colval = int32([1 1 2 2 3 3 3 4 4 4 5 5 5 5 6 6 7 7 8 8 ]);
M_.static_g1_sparse_colptr = int32([1 3 5 8 11 15 17 19 21 ]);
M_.params(1) = 2;
sigma = M_.params(1);
M_.params(2) = 0.98;
bbeta = M_.params(2);
