...
M_.block_structure.block(2).variable = [ 8 2 6 7 5 9 4];
...
M_.block_structure.block(2).g1_sparse_rowval = int32([1 4 6 7 1 7 1 2 4 5 2 3 2 3 4 5 6 6 7 3 5 7 7 ]);
M_.block_structure.block(2).g1_sparse_colval = int32([6 6 6 6 8 8 9 9 9 9 10 10 11 11 11 12 12 13 13 14 14 14 21 ]);
M_.block_structure.block(2).g1_sparse_colptr = int32([1 1 1 1 1 1 5 5 7 11 13 16 18 20 23 23 23 23 23 23 23 24 ]);
...
M_.block_structure.variable_reordered = [ 1 8 2 6 7 5 9 4 3];
M_.block_structure.equation_reordered = [ 7 2 4 5 1 8 3 6 9];
...
M_.dynamic_g1_sparse_rowval = int32([7 1 2 3 6 1 7 1 2 4 8 9 9 5 6 8 3 8 4 5 1 4 5 2 6 3 6 6 7 ]);
M_.dynamic_g1_sparse_colval = int32([1 9 9 9 9 10 10 11 11 11 11 11 12 13 13 13 14 14 15 15 16 16 16 17 17 18 18 22 28 ]);
M_.dynamic_g1_sparse_colptr = int32([1 2 2 2 2 2 2 2 2 6 8 13 14 17 19 21 24 26 28 28 28 28 29 29 29 29 29 29 30 ]);
M_.lhs = {
'Y'; 
'R_K'; 
'K'; 
